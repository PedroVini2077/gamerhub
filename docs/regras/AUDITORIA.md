...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->358<!--/n--> arquivos · <!--n:src.linhas-->36.411<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->109<!--/n--> · `components` <!--n:src.components.arquivos-->165<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->42<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->17<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->75<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->17<!--/n--> roteiros de navegador |
...
> <!--n:src.linhas-->36.411<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
