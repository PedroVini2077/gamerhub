...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->389<!--/n--> arquivos · <!--n:src.linhas-->41.267<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->123<!--/n--> · `components` <!--n:src.components.arquivos-->181<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->43<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->17<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->87<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->18<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->389<!--/n--> arquivos,
> <!--n:src.linhas-->41.267<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
<!--n:src.components.arquivos-->181<!--/n--> de `components/`, escolhidos pelos
...
"li <!--n:src.arquivos-->389<!--/n--> de <!--n:src.arquivos-->389<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->389<!--/n-->, parei em X". Nunca deixar parecer
