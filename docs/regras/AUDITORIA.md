...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->464<!--/n--> arquivos · <!--n:src.linhas-->51.702<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->166<!--/n--> · `components` <!--n:src.components.arquivos-->198<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->47<!--/n--> · `pages` <!--n:src.pages.arquivos-->25<!--/n--> · `services` <!--n:src.services.arquivos-->25<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->121<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->23<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->464<!--/n--> arquivos,
> <!--n:src.linhas-->51.702<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
<!--n:src.components.arquivos-->198<!--/n--> de `components/`, escolhidos pelos
...
"li <!--n:src.arquivos-->464<!--/n--> de <!--n:src.arquivos-->464<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->464<!--/n-->, parei em X". Nunca deixar parecer
