...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->349<!--/n--> arquivos · <!--n:src.linhas-->35.025<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->100<!--/n--> · `components` <!--n:src.components.arquivos-->165<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->42<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->17<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->72<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->17<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->349<!--/n--> arquivos,
> <!--n:src.linhas-->35.025<!--/n--> linhas, 73 funções `SECURITY DEFINER` — e a
...
"li <!--n:src.arquivos-->349<!--/n--> de <!--n:src.arquivos-->349<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->349<!--/n-->, parei em X". Nunca deixar parecer
