...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->334<!--/n--> arquivos · <!--n:src.linhas-->33.382<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->95<!--/n--> · `components` <!--n:src.components.arquivos-->160<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->37<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->17<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->65<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->16<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->334<!--/n--> arquivos,
> <!--n:src.linhas-->33.382<!--/n--> linhas, 73 funções `SECURITY DEFINER` — e a
...
<!--n:src.components.arquivos-->160<!--/n--> de `components/`, escolhidos pelos
...
"li <!--n:src.arquivos-->334<!--/n--> de <!--n:src.arquivos-->334<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->334<!--/n-->, parei em X". Nunca deixar parecer
