...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->344<!--/n--> arquivos · <!--n:src.linhas-->34.397<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->98<!--/n--> · `components` <!--n:src.components.arquivos-->165<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->39<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->17<!--/n--> |
...
> **dobrou** — <!--n:src.arquivos-->344<!--/n--> arquivos,
> <!--n:src.linhas-->34.397<!--/n--> linhas, 73 funções `SECURITY DEFINER` — e a
...
"li <!--n:src.arquivos-->344<!--/n--> de <!--n:src.arquivos-->344<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->344<!--/n-->, parei em X". Nunca deixar parecer
