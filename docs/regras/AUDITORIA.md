...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->308<!--/n--> arquivos · <!--n:src.linhas-->29.612<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->86<!--/n--> · `components` <!--n:src.components.arquivos-->146<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->36<!--/n--> · `pages` <!--n:src.pages.arquivos-->21<!--/n--> · `services` <!--n:src.services.arquivos-->16<!--/n--> |
...
> **dobrou** — <!--n:src.arquivos-->308<!--/n--> arquivos,
> <!--n:src.linhas-->29.612<!--/n--> linhas, 73 funções `SECURITY DEFINER` — e a
...
"li <!--n:src.arquivos-->308<!--/n--> de <!--n:src.arquivos-->308<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->308<!--/n-->, parei em X". Nunca deixar parecer
