...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->351<!--/n--> arquivos · <!--n:src.linhas-->35.453<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->101<!--/n--> · `components` <!--n:src.components.arquivos-->166<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->42<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->17<!--/n--> |
...
> <!--n:src.linhas-->35.453<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
