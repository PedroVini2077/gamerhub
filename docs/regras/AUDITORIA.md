...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->355<!--/n--> arquivos · <!--n:src.linhas-->35.821<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->105<!--/n--> · `components` <!--n:src.components.arquivos-->167<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->41<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->17<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->76<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->18<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->355<!--/n--> arquivos,
> <!--n:src.linhas-->35.821<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
"li <!--n:src.arquivos-->355<!--/n--> de <!--n:src.arquivos-->355<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->355<!--/n-->, parei em X". Nunca deixar parecer
