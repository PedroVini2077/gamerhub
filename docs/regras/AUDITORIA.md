...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->309<!--/n--> arquivos · <!--n:src.linhas-->29.766<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->86<!--/n--> · `components` <!--n:src.components.arquivos-->146<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->37<!--/n--> · `pages` <!--n:src.pages.arquivos-->21<!--/n--> · `services` <!--n:src.services.arquivos-->16<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->54<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->14<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->309<!--/n--> arquivos,
> <!--n:src.linhas-->29.766<!--/n--> linhas, 73 funções `SECURITY DEFINER` — e a
...
<!--n:src.components.arquivos-->146<!--/n--> de `components/`, escolhidos pelos
...
"li <!--n:src.arquivos-->309<!--/n--> de <!--n:src.arquivos-->309<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->309<!--/n-->, parei em X". Nunca deixar parecer
