...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->351<!--/n--> arquivos · <!--n:src.linhas-->35.627<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->107<!--/n--> · `components` <!--n:src.components.arquivos-->160<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->42<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->17<!--/n--> |
...
> **dobrou** — <!--n:src.arquivos-->351<!--/n--> arquivos,
> <!--n:src.linhas-->35.627<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
"li <!--n:src.arquivos-->351<!--/n--> de <!--n:src.arquivos-->351<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->351<!--/n-->, parei em X". Nunca deixar parecer
