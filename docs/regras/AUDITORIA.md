...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->311<!--/n--> arquivos · <!--n:src.linhas-->29.932<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->86<!--/n--> · `components` <!--n:src.components.arquivos-->148<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->37<!--/n--> · `pages` <!--n:src.pages.arquivos-->21<!--/n--> · `services` <!--n:src.services.arquivos-->16<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->55<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->14<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->311<!--/n--> arquivos,
> <!--n:src.linhas-->29.932<!--/n--> linhas, 73 funções `SECURITY DEFINER` — e a
...
<!--n:src.components.arquivos-->148<!--/n--> de `components/`, escolhidos pelos
...
"li <!--n:src.arquivos-->311<!--/n--> de <!--n:src.arquivos-->311<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->311<!--/n-->, parei em X". Nunca deixar parecer
