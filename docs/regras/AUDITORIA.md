...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->395<!--/n--> arquivos · <!--n:src.linhas-->42.710<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->128<!--/n--> · `components` <!--n:src.components.arquivos-->182<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->43<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->17<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->92<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->19<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->395<!--/n--> arquivos,
> <!--n:src.linhas-->42.710<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
<!--n:src.components.arquivos-->182<!--/n--> de `components/`, escolhidos pelos
...
"li <!--n:src.arquivos-->395<!--/n--> de <!--n:src.arquivos-->395<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->395<!--/n-->, parei em X". Nunca deixar parecer
