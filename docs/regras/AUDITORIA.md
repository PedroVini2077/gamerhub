...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->409<!--/n--> arquivos · <!--n:src.linhas-->44.883<!--/n--> linhas |
...
| rede de testes | <!--n:testes.arquivos-->101<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->20<!--/n--> roteiros de navegador |
...
> <!--n:src.linhas-->44.883<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
