...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->373<!--/n--> arquivos · <!--n:src.linhas-->38.646<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->113<!--/n--> · `components` <!--n:src.components.arquivos-->175<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->43<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->17<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->78<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->17<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->373<!--/n--> arquivos,
> <!--n:src.linhas-->38.646<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
<!--n:src.components.arquivos-->175<!--/n--> de `components/`, escolhidos pelos
...
"li <!--n:src.arquivos-->373<!--/n--> de <!--n:src.arquivos-->373<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->373<!--/n-->, parei em X". Nunca deixar parecer
