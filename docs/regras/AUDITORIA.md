...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->408<!--/n--> arquivos · <!--n:src.linhas-->44.659<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->136<!--/n--> · `components` <!--n:src.components.arquivos-->184<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->44<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->19<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->100<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->20<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->408<!--/n--> arquivos,
> <!--n:src.linhas-->44.659<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
<!--n:src.components.arquivos-->184<!--/n--> de `components/`, escolhidos pelos
...
"li <!--n:src.arquivos-->408<!--/n--> de <!--n:src.arquivos-->408<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->408<!--/n-->, parei em X". Nunca deixar parecer
