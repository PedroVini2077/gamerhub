...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->421<!--/n--> arquivos · <!--n:src.linhas-->46.247<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->144<!--/n--> · `components` <!--n:src.components.arquivos-->185<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->47<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->20<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->109<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->23<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->421<!--/n--> arquivos,
> <!--n:src.linhas-->46.247<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
"li <!--n:src.arquivos-->421<!--/n--> de <!--n:src.arquivos-->421<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->421<!--/n-->, parei em X". Nunca deixar parecer
