...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->393<!--/n--> arquivos · <!--n:src.linhas-->42.294<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->126<!--/n--> · `components` <!--n:src.components.arquivos-->182<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->43<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->17<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->90<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->19<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->393<!--/n--> arquivos,
> <!--n:src.linhas-->42.294<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
"li <!--n:src.arquivos-->393<!--/n--> de <!--n:src.arquivos-->393<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->393<!--/n-->, parei em X". Nunca deixar parecer
