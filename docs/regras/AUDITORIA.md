...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->469<!--/n--> arquivos · <!--n:src.linhas-->52.276<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->169<!--/n--> · `components` <!--n:src.components.arquivos-->199<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->47<!--/n--> · `pages` <!--n:src.pages.arquivos-->26<!--/n--> · `services` <!--n:src.services.arquivos-->25<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->123<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->23<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->469<!--/n--> arquivos,
> <!--n:src.linhas-->52.276<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
<!--n:src.components.arquivos-->199<!--/n--> de `components/`, escolhidos pelos
...
"li <!--n:src.arquivos-->469<!--/n--> de <!--n:src.arquivos-->469<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->469<!--/n-->, parei em X". Nunca deixar parecer
