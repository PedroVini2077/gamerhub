...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->345<!--/n--> arquivos · <!--n:src.linhas-->34.582<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->101<!--/n--> · `components` <!--n:src.components.arquivos-->161<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->41<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->17<!--/n--> |
...
> <!--n:src.linhas-->34.582<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
