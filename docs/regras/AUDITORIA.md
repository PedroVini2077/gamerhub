...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->455<!--/n--> arquivos · <!--n:src.linhas-->50.507<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->161<!--/n--> · `components` <!--n:src.components.arquivos-->195<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->47<!--/n--> · `pages` <!--n:src.pages.arquivos-->25<!--/n--> · `services` <!--n:src.services.arquivos-->24<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->118<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->23<!--/n--> roteiros de navegador |
| Edge Functions | <!--n:edge.funcoes-->9<!--/n--> |
...
> **dobrou** — <!--n:src.arquivos-->455<!--/n--> arquivos,
> <!--n:src.linhas-->50.507<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
<!--n:src.components.arquivos-->195<!--/n--> de `components/`, escolhidos pelos
...
"li <!--n:src.arquivos-->455<!--/n--> de <!--n:src.arquivos-->455<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->455<!--/n-->, parei em X". Nunca deixar parecer
