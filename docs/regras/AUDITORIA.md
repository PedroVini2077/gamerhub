...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->404<!--/n--> arquivos · <!--n:src.linhas-->44.230<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->135<!--/n--> · `components` <!--n:src.components.arquivos-->183<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->43<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->18<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->99<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->20<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->404<!--/n--> arquivos,
> <!--n:src.linhas-->44.230<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
<!--n:src.components.arquivos-->183<!--/n--> de `components/`, escolhidos pelos
...
"li <!--n:src.arquivos-->404<!--/n--> de <!--n:src.arquivos-->404<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->404<!--/n-->, parei em X". Nunca deixar parecer
