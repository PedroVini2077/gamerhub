...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->429<!--/n--> arquivos · <!--n:src.linhas-->47.281<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->148<!--/n--> · `components` <!--n:src.components.arquivos-->187<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->47<!--/n--> · `pages` <!--n:src.pages.arquivos-->23<!--/n--> · `services` <!--n:src.services.arquivos-->21<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->112<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->23<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->429<!--/n--> arquivos,
> <!--n:src.linhas-->47.281<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
<!--n:src.components.arquivos-->187<!--/n--> de `components/`, escolhidos pelos
...
"li <!--n:src.arquivos-->429<!--/n--> de <!--n:src.arquivos-->429<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->429<!--/n-->, parei em X". Nunca deixar parecer
