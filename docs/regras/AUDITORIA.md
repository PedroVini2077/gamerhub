...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->414<!--/n--> arquivos · <!--n:src.linhas-->45.443<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->139<!--/n--> · `components` <!--n:src.components.arquivos-->185<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->46<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->19<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->105<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->22<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->414<!--/n--> arquivos,
> <!--n:src.linhas-->45.443<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
"li <!--n:src.arquivos-->414<!--/n--> de <!--n:src.arquivos-->414<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->414<!--/n-->, parei em X". Nunca deixar parecer
