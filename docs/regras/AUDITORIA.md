...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->381<!--/n--> arquivos · <!--n:src.linhas-->39.881<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->116<!--/n--> · `components` <!--n:src.components.arquivos-->180<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->43<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->17<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->81<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->17<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->381<!--/n--> arquivos,
> <!--n:src.linhas-->39.881<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
"li <!--n:src.arquivos-->381<!--/n--> de <!--n:src.arquivos-->381<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->381<!--/n-->, parei em X". Nunca deixar parecer
