...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->324<!--/n--> arquivos · <!--n:src.linhas-->31.564<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->89<!--/n--> · `components` <!--n:src.components.arquivos-->156<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->37<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->17<!--/n--> |
...
> **dobrou** — <!--n:src.arquivos-->324<!--/n--> arquivos,
> <!--n:src.linhas-->31.564<!--/n--> linhas, 73 funções `SECURITY DEFINER` — e a
...
<!--n:src.components.arquivos-->156<!--/n--> de `components/`, escolhidos pelos
...
"li <!--n:src.arquivos-->324<!--/n--> de <!--n:src.arquivos-->324<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->324<!--/n-->, parei em X". Nunca deixar parecer
