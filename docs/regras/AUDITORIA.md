...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->338<!--/n--> arquivos · <!--n:src.linhas-->33.971<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->98<!--/n--> · `components` <!--n:src.components.arquivos-->161<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->37<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->17<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->67<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->16<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->338<!--/n--> arquivos,
> <!--n:src.linhas-->33.971<!--/n--> linhas, 73 funções `SECURITY DEFINER` — e a
...
"li <!--n:src.arquivos-->338<!--/n--> de <!--n:src.arquivos-->338<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->338<!--/n-->, parei em X". Nunca deixar parecer
