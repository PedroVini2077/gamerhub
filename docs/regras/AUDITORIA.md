...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->433<!--/n--> arquivos · <!--n:src.linhas-->48.127<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->151<!--/n--> · `components` <!--n:src.components.arquivos-->188<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->47<!--/n--> · `pages` <!--n:src.pages.arquivos-->23<!--/n--> · `services` <!--n:src.services.arquivos-->21<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->114<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->23<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->433<!--/n--> arquivos,
> <!--n:src.linhas-->48.127<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
"li <!--n:src.arquivos-->433<!--/n--> de <!--n:src.arquivos-->433<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->433<!--/n-->, parei em X". Nunca deixar parecer
