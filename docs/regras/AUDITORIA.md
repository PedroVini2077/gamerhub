...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->402<!--/n--> arquivos · <!--n:src.linhas-->43.870<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->133<!--/n--> · `components` <!--n:src.components.arquivos-->183<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->43<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->18<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->97<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->19<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->402<!--/n--> arquivos,
> <!--n:src.linhas-->43.870<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
"li <!--n:src.arquivos-->402<!--/n--> de <!--n:src.arquivos-->402<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->402<!--/n-->, parei em X". Nunca deixar parecer
