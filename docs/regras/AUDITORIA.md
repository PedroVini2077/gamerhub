...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->354<!--/n--> arquivos · <!--n:src.linhas-->35.707<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->104<!--/n--> · `components` <!--n:src.components.arquivos-->166<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->42<!--/n--> · `pages` <!--n:src.pages.arquivos-->22<!--/n--> · `services` <!--n:src.services.arquivos-->17<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->75<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->18<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->354<!--/n--> arquivos,
> <!--n:src.linhas-->35.707<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
<!--n:src.components.arquivos-->166<!--/n--> de `components/`, escolhidos pelos
...
"li <!--n:src.arquivos-->354<!--/n--> de <!--n:src.arquivos-->354<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->354<!--/n-->, parei em X". Nunca deixar parecer
