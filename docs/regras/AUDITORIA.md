...
| | |
| --- | --- |
| código em `src/` | <!--n:src.arquivos-->446<!--/n--> arquivos · <!--n:src.linhas-->49.566<!--/n--> linhas |
| dividido em | `lib` <!--n:src.lib.arquivos-->157<!--/n--> · `components` <!--n:src.components.arquivos-->191<!--/n--> · `hooks` <!--n:src.hooks.arquivos-->47<!--/n--> · `pages` <!--n:src.pages.arquivos-->25<!--/n--> · `services` <!--n:src.services.arquivos-->23<!--/n--> |
| rede de testes | <!--n:testes.arquivos-->116<!--/n--> arquivos de teste · <!--n:e2e.roteiros-->23<!--/n--> roteiros de navegador |
...
> **dobrou** — <!--n:src.arquivos-->446<!--/n--> arquivos,
> <!--n:src.linhas-->49.566<!--/n--> linhas, e 73 funções `SECURITY DEFINER`
...
<!--n:src.components.arquivos-->191<!--/n--> de `components/`, escolhidos pelos
...
"li <!--n:src.arquivos-->446<!--/n--> de <!--n:src.arquivos-->446<!--/n-->
arquivos" ou "li 40 de <!--n:src.arquivos-->446<!--/n-->, parei em X". Nunca deixar parecer
