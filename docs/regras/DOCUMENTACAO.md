...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->43<!--/n-->
...
comentário HTML — `<!--n:src.arquivos-->387<!--/n-->` —, invisível no markdown
...
<!--n:docs.linhas-->19.870<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->43<!--/n--> por idade, para varredura completa.
