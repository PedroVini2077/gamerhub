...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->35<!--/n-->
...
comentário HTML — `<!--n:src.arquivos-->371<!--/n-->` —, invisível no markdown
...
<!--n:docs.linhas-->16.596<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->35<!--/n--> por idade, para varredura completa.
