...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->30<!--/n-->
...
<!--n:docs.linhas-->12.657<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->30<!--/n--> por idade, para varredura completa.
