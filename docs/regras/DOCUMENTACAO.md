...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->39<!--/n-->
...
<!--n:docs.linhas-->19.136<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->39<!--/n--> por idade, para varredura completa.
