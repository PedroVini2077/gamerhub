...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->50<!--/n-->
...
<!--n:docs.linhas-->22.245<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->50<!--/n--> por idade, para varredura completa.
