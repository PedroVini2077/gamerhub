...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->38<!--/n-->
...
comentário HTML — `<!--n:src.arquivos-->381<!--/n-->` —, invisível no markdown
...
<!--n:docs.linhas-->18.317<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->38<!--/n--> por idade, para varredura completa.
