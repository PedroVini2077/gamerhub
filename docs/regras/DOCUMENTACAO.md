...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->33<!--/n-->
...
<!--n:docs.linhas-->14.287<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->33<!--/n--> por idade, para varredura completa.
