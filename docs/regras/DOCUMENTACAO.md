...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->37<!--/n-->
...
comentário HTML — `<!--n:src.arquivos-->377<!--/n-->` —, invisível no markdown
...
<!--n:docs.linhas-->17.575<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->37<!--/n--> por idade, para varredura completa.
