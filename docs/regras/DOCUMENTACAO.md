...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->41<!--/n-->
...
<!--n:docs.linhas-->19.641<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->41<!--/n--> por idade, para varredura completa.
