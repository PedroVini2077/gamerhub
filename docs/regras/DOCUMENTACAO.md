...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->48<!--/n-->
...
comentário HTML — `<!--n:src.arquivos-->389<!--/n-->` —, invisível no markdown
...
<!--n:docs.linhas-->21.461<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->48<!--/n--> por idade, para varredura completa.
