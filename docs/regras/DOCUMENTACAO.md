...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->34<!--/n-->
...
<!--n:docs.linhas-->15.172<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->34<!--/n--> por idade, para varredura completa.
