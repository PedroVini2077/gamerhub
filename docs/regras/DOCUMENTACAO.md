...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->47<!--/n-->
...
comentário HTML — `<!--n:src.arquivos-->388<!--/n-->` —, invisível no markdown
...
<!--n:docs.linhas-->20.981<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->47<!--/n--> por idade, para varredura completa.
