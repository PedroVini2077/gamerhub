...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->49<!--/n-->
...
<!--n:docs.linhas-->21.620<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->49<!--/n--> por idade, para varredura completa.
