...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->52<!--/n-->
...
comentário HTML — `<!--n:src.arquivos-->395<!--/n-->` —, invisível no markdown
...
<!--n:docs.linhas-->23.267<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->52<!--/n--> por idade, para varredura completa.
