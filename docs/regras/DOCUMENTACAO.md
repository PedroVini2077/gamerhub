...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->44<!--/n-->
...
<!--n:docs.linhas-->20.140<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->44<!--/n--> por idade, para varredura completa.
