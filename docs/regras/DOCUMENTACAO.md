...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->51<!--/n-->
...
comentário HTML — `<!--n:src.arquivos-->393<!--/n-->` —, invisível no markdown
...
<!--n:docs.linhas-->22.516<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->51<!--/n--> por idade, para varredura completa.
