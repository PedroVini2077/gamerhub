...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->42<!--/n-->
...
comentário HTML — `<!--n:src.arquivos-->384<!--/n-->` —, invisível no markdown
...
<!--n:docs.linhas-->19.757<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->42<!--/n--> por idade, para varredura completa.
