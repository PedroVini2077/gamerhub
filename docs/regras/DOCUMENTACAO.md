...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->36<!--/n-->
...
<!--n:docs.linhas-->17.289<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->36<!--/n--> por idade, para varredura completa.
