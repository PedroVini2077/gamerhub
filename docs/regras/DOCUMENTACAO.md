...
> **`[02/09]` Esta tabela listava 11 dos <!--n:docs.arquivos-->31<!--/n-->
...
comentário HTML — `<!--n:src.arquivos-->349<!--/n-->` —, invisível no markdown
...
<!--n:docs.linhas-->13.347<!--/n--> linhas por precaução a cada sessão consome
...
<!--n:docs.arquivos-->31<!--/n--> por idade, para varredura completa.
