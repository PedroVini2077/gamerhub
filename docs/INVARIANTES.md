...
| **INV-EDIT-003** | **`[25/09]`** O assistente do News **sugere a partir do que já foi escrito** e nunca gera conteúdo novo. Sugestão é sempre um BOTÃO — nada se aplica sozinho, nem em campo vazio. Texto redigido a partir de um título inventa fato, data e número, e sai assinado pelo GamerHub, que promete o contrário na landing | pergunta dele em 25/09 | `assistenteSugereNaoDecide.test.js` |
