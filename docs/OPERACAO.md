...
linhas"* num projeto de <!--n:src.arquivos-->342<!--/n--> arquivos e
<!--n:src.linhas-->34.319<!--/n--> linhas.
...
comentário HTML — `<!--n:src.arquivos-->342<!--/n-->` —, invisível no markdown
...
mandar reler <!--n:docs.linhas-->12.146<!--/n--> linhas por precaução — o que
