...
- **piso de <!--n:testes.piso-->479<!--/n--> testes** — o CI quebrando é o caso
...
linhas"* num projeto de <!--n:src.arquivos-->324<!--/n--> arquivos e
<!--n:src.linhas-->31.564<!--/n--> linhas.
...
comentário HTML — `<!--n:src.arquivos-->324<!--/n-->` —, invisível no markdown
...
mandar reler <!--n:docs.linhas-->11.189<!--/n--> linhas por precaução — o que
