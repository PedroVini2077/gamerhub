...
linhas"* num projeto de <!--n:src.arquivos-->330<!--/n--> arquivos e
<!--n:src.linhas-->32.802<!--/n--> linhas.
...
comentário HTML — `<!--n:src.arquivos-->330<!--/n-->` —, invisível no markdown
...
mandar reler <!--n:docs.linhas-->11.522<!--/n--> linhas por precaução — o que
