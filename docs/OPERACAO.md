...
linhas"* num projeto de <!--n:src.arquivos-->326<!--/n--> arquivos e
<!--n:src.linhas-->32.091<!--/n--> linhas.
...
comentário HTML — `<!--n:src.arquivos-->326<!--/n-->` —, invisível no markdown
...
mandar reler <!--n:docs.linhas-->11.328<!--/n--> linhas por precaução — o que
