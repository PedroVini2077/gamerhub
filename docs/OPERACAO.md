...
linhas"* num projeto de <!--n:src.arquivos-->325<!--/n--> arquivos e
<!--n:src.linhas-->31.951<!--/n--> linhas.
...
comentário HTML — `<!--n:src.arquivos-->325<!--/n-->` —, invisível no markdown
...
mandar reler <!--n:docs.linhas-->11.280<!--/n--> linhas por precaução — o que
