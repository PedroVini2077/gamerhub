...
linhas"* num projeto de <!--n:src.arquivos-->316<!--/n--> arquivos e
<!--n:src.linhas-->30.518<!--/n--> linhas.
...
comentário HTML — `<!--n:src.arquivos-->316<!--/n-->` —, invisível no markdown
...
mandar reler <!--n:docs.linhas-->10.435<!--/n--> linhas por precaução — o que
