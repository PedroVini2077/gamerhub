...
| [`supabase/migrations/`](supabase/migrations/README.md) | **A verdade sobre o schema** — <!--n:migrations-->233<!--/n--> migrations que recriam o banco |
...
**[migrations](supabase/migrations/)** em ordem — são <!--n:migrations-->233<!--/n-->, e elas reconstroem o
