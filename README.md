...
| [`supabase/migrations/`](supabase/migrations/README.md) | **A verdade sobre o schema** — <!--n:migrations-->194<!--/n--> migrations que recriam o banco |
...
**[migrations](supabase/migrations/)** em ordem — são <!--n:migrations-->194<!--/n-->, e elas reconstroem o
