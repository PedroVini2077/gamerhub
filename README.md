...
| [`supabase/migrations/`](supabase/migrations/README.md) | **A verdade sobre o schema** — <!--n:migrations-->211<!--/n--> migrations que recriam o banco |
...
**[migrations](supabase/migrations/)** em ordem — são <!--n:migrations-->211<!--/n-->, e elas reconstroem o
