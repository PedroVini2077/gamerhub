    ...
    <div className="max-w-lg mx-auto space-y-4">
      <div className="card p-6">
        <div className="flex items-center gap-4 mb-6">
          <div className="w-16 h-16 rounded-full bg-dark-400 border-2 border-neon-green/40 flex items-center justify-center" style={{ boxShadow: '0 0 20px #39ff1420' }}>
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea className="input-gamer resize-none" rows={3} placeholder="Fale um pouco sobre você..." value={bio} onChange={e => setBio(e.target.value)} maxLength={200} />
          </div>
