...
/**
 * As duas listas de contrato moram em `listasDeclaradas.js` — o que o CÓDIGO
 * faz, não o que a página diz. Reexportadas aqui porque este continua sendo o
 * endereço que `documentosLegais.js` aponta como "o conteúdo da política".
 */
export { CHAVES_DECLARADAS, TERCEIROS_DECLARADOS } from './listasDeclaradas';
