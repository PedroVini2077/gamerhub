 ...
 */
const POSICOES = [
  { x: '6%',  tamanho: 62, duracao: 54, atraso: -8,  deriva: '5vw',  giro: '38deg',  pico: 0.52 },
  { x: '19%', tamanho: 40, duracao: 68, atraso: -34, deriva: '-4vw', giro: '-26deg', pico: 0.42 },
  { x: '32%', tamanho: 76, duracao: 46, atraso: -20, deriva: '3vw',  giro: '52deg',  pico: 0.58 },
  { x: '45%', tamanho: 46, duracao: 74, atraso: -50, deriva: '-6vw', giro: '30deg',  pico: 0.40 },
  { x: '58%', tamanho: 66, duracao: 58, atraso: -14, deriva: '4vw',  giro: '-44deg', pico: 0.54 },
  { x: '70%', tamanho: 38, duracao: 80, atraso: -62, deriva: '-3vw', giro: '22deg',  pico: 0.40 },
  { x: '82%', tamanho: 70, duracao: 50, atraso: -28, deriva: '6vw',  giro: '-34deg', pico: 0.56 },
  { x: '93%', tamanho: 44, duracao: 66, atraso: -44, deriva: '-5vw', giro: '46deg',  pico: 0.44 },
];
