...
// Este arquivo usava uma TERCEIRA convenção: lançava exceção (`throw error`) e
// os chamadores envolviam tudo em try/catch. Agora segue o contrato de
// `result.js` como o resto — quem chama olha `error`, não captura.
