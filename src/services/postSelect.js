...
const POST_COLUMNS = [
  // `[24/09]` `category` saiu daqui junto com a UI que a lia — e a coluna foi
  // apagada do banco no mesmo dia. Pedi-la de volta agora não é desperdício de
  // bytes: é erro de consulta.
